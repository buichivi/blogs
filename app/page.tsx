  ...
  return (
    <div className='wrapper'>
      <div className='flex items-center justify-center pb-[30px]'>
        <h1 className='w-full lg:text-[245px] md:text-[160px] text-center uppercase font-bold border-t-[1px] border-b-[1px] border-slate-400 dark:border-slate-300 py-[25px]'>
          The blog
        </h1>
      </div>
      <RecentBlogPost />
