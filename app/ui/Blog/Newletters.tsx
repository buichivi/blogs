  ...
  return (
    <div className='mt-8'>
      <div>
        ...
        <h3 className='pt-3 pb-6 text-5xl text-center font-semibold'>Stories and interviews</h3>
        <p className='text-center'>
          <span className='w-3/5 text-xl font-normal text-[#C0C5D0]'>
            Subscribe to learn about new product features, the latest in technology, solutions, and
            updates.
          </span>
        </p>
      </div>
      <div className='flex items-start justify-between gap-4 w-3/5 mx-auto mt-10'>
