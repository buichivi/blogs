...
export default function AllBlogPosts() {
  return (
    <div className='py-[30px]' id='all-post'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-0 gap-y-4 md:gap-x-4 md:gap-y-6 lg:gap-x-8 lg:gap-y-12 pb-[30px] border-b-[1px] border-slate-400 dark:border-slate-300'>
        {Array(6)
          .fill(0)
          .map((post, index) => {
            return (
